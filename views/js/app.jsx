const AUTH0_CLIENT_ID = 'jeIlJXSq3pzw3uFZs4rYi7hfzCu03txj';
const AUTH0_DOMAIN = "caquillo.auth0.com";
const AUTH0_CALLBACK_URL = location.href;
const AUTH0_API_AUDIENCE = "jokerish-api";
...
class App extends React.Component {
    ...
    render() {
        return this.loggedIn ? (<LoggedIn/>) : (<Home/>);
    }
}
...
class Joke extends React.Component {
    ...
    like() {
        this.serverRequest(this.props.joke);
    }
